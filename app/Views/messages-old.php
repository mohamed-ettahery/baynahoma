                            ...
                            <div class="content-box">
                                <?php if(isset($messages)&&!empty($messages)):?>
                                    <?php foreach($messages as $message): ?>
                                        <div <?=$message->msgFrom == $me ?"style='text-align: -webkit-left;'":""?>>
                                            <div class="message-box <?=$message->msgFrom == $me ?"msg-from-me":""?>">
                                                <p><?=$message->msg?></p>
                                            </div>
                                        </div>
                                    <?php endforeach;?>
                                                ...
                                                var elements = "";
                                                    for (var i = 0; i < users.length; i++) {
                                                        var userId   = users[i].id,
                                                            ...
                                                            var element ="";
                                                                element = " <div class='box_user'><a href='"+hrefUrl+"'  class='btn' ><div class='row'><div class='col-4'><img src='"+imgUrl+"' class='img-thumbnail rounded-circle' /></div><div class='col-8 pt-3'><h6>"+userName+"</h6><p class='para-msg'>"+msg+"</p></div></div></a></div>";
                                                                elements+=element;
